...
<html>
  ...
  <body>
    <div class="container">
      <div class="header">
        <div class="content"><div class="image"><!-- TemplateBeginEditable name="image" --><img src="../images/pg_title_canteen.png" alt="Canteen" name="Head" display:block;/><!-- TemplateEndEditable --></div></div>
      </div>
      <div class="content">
